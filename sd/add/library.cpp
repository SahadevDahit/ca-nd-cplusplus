...
void Lib::get()
{
   int i;
   cout<<"\t\t\t";
        type("***********NAST LIBRARY MANAGEMENT SYSTEM ***********");
        cout<<"\n\n";
        cout<<"\t\t\t";
        type("**********Project by  GROUP -9 fourth semester in NAST 2077************");
        cout<<"\n\n";
        cout<<"\t\t\t";
		 type("1.Book record  2.Librarian 3.Student 4.Exit");
		 cout<<"\n\n";
